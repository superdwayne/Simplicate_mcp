...
export const metadata: ToolMetadata = {
  name: "list-project-budgets",
  description: "List project budgets",
};

export default async function listProjectBudgets(
  {
    page,
    limit,
    project_id,
  ...
  try {
    ...
    const res = await simplicate(extra).get("/projects/projectbudget", {
